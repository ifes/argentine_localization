...
public class MenuElementHandler_342 extends AbstractElementHandler {
	...
	public void startElement(Properties ctx, Element element)
		...
		if (menuid <= 0 && atts.getValue("AD_Menu_ID") != null && Integer.parseInt(atts.getValue("AD_Menu_ID")) <= PackOut_342.MAX_OFFICIAL_ID)
	...
	private AttributesImpl createMenuBinding(AttributesImpl atts,
		...
		if (m_Menu.getAD_Menu_ID() <= PackOut_342.MAX_OFFICIAL_ID)
