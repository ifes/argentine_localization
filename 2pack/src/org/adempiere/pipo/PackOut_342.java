...
import org.adempiere.pipo.handler.MenuElementHandler_342;
...
import org.adempiere.pipo.handler.TableElementHandler_342;
import org.adempiere.pipo.handler.TaskElementHandler;
import org.adempiere.pipo.handler.WindowElementHandler_342;
...
public class PackOut_342 extends SvrProcess
{
	/** Record ID				*/
    ...
    WindowElementHandler_342 windowHandler = new WindowElementHandler_342();
    MenuElementHandler_342 menuHandler = new MenuElementHandler_342();
    ...
    TableElementHandler_342 tableHandler = new TableElementHandler_342();
	 ...
	 * @throws SAXException
	 */
	public void createTable (int table_id, TransformerHandler packOutDocument,String entityType) throws SAXException
	{	
		Env.setContext(getCtx(), X_AD_Package_Exp_Detail.COLUMNNAME_AD_Table_ID, table_id);
		if(entityType!=null)
			tableHandler.create(getCtx(), packOutDocument,entityType);
		else
			tableHandler.create(getCtx(), packOutDocument);
		getCtx().remove(X_AD_Package_Exp_Detail.COLUMNNAME_AD_Table_ID);
	}	
