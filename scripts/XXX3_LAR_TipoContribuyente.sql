...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=14),  -- AD_Reference_ID
 0, 0, 'Y', '2010-08-30 17:22:21.0', 100, '2010-09-02 21:51:50.0', 100, 'LAR_ClaseDocumento', 'Clase de Documento', 'Clase de Documento (DNI, CUIT, CUIL, etc.)', 'T', NULL, 'OPB_LAR', 'N');
...
'N', 'LAR_ClaseDocumento.IsActive=''Y''', NULL, 'OPB_LAR', NULL);
--
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
 0, 0, 'Y', '2010-08-30 16:18:42.0', 100, '2010-08-30 16:18:42.0', 100, 'Tipo Contribuyente', 'Tipo de contribuyente', 'Indica el tipo de contribuyente para la AFIP', 'LAR_TipoContribuyente', 'N', '6', 'OPB_LAR', NULL, NULL, 0, 'N', 'Y', 'N', 'N', 'N', 'L', NULL, 'N', 'Y');
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=27),  -- AD_Window_ID
 0, 0, 'Y', '2010-08-30 16:38:58.0', 100, '2010-08-30 16:38:58.0', 100, 'Tipo Contribuyente', 'Tipo de contribuyente', 'Almacena los tipos de contribuyentes segun AFIP', 'M', 'Y', 'OPB_LAR', 'N', NULL, NULL, 'N', 0, 0, 'N');
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=27),  -- AD_Window_ID
10, 0, 'N', 'N', 'N', 'N', NULL, 'N', NULL, NULL, NULL, NULL, 'N', NULL, 'N', NULL, NULL, 'N', 'OPB_LAR', NULL, NULL, NULL, 'Y', 'N', NULL);
...
0, 0, 'Y', '2010-08-30 16:37:44.0', '2010-08-30 16:37:44.0', 100, 100, 'Client', 'Client/Tenant for this installation.', 'A Client is a company or a legal entity. You cannot share data between Clients. Tenant is a synonym for Client.', 0, 'OPB_LAR', 'AD_Client_ID', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 25, 'N', 10, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 16:37:45.0', 100, 100, 'Organization', 'Organizational entity within client', 'An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.', 0, 'OPB_LAR', 'AD_Org_ID', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 25, 'N', 20, NULL, 'Y', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
If you leave the search key empty, the system automatically creates a numeric number.  The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).', 0, 'OPB_LAR', 'Value', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 10, 'N', 30, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=188),  --  AD_Element_ID
 0, 0, 'Y', '2010-08-30 16:12:59.0', 100, '2010-08-30 16:12:59.0', 100, 'CodeAFIP', 'OPB_LAR', 'Codigo AFIP', 'Codigo AFIP', 'Codigo segun AFIP', 'Indica el codigo para la AFIP', NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-09-02 21:48:41.0', 100, 100, 'Codigo AFIP', 'Codigo segun AFIP', 'Indica el codigo para la AFIP', 0, 'OPB_LAR', 'CodeAFIP', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 3, 'N', 40, NULL, 'Y', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 16:37:45.0', 100, 100, 'Name', 'Alphanumeric identifier of the entity', 'The name of an entity (record) is used as an default search option in addition to the search key. The name is up to 60 characters in length.', 0, 'OPB_LAR', 'Name', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 60, 'N', 50, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 16:37:45.0', 100, 100, 'Description', 'Optional short description of the record', 'A description is limited to 255 characters.', 0, 'OPB_LAR', 'Description', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 255, 'N', 60, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Element(ad_element_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, columnname, entitytype, name, printname, description, help, po_name, po_printname, po_description, po_help)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=188),  --  AD_Element_ID
 0, 0, 'Y', '2010-08-30 16:14:22.0', 100, '2010-08-30 16:14:22.0', 100, 'DiscriminateTax', 'OPB_LAR', 'Discrimina I.V.A.', 'Discrimina I.V.A.', 'Discrimina el I.V.A.', 'Indica si se discrimina I.V.A. para este contribuyente', NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 16:37:45.0', 100, 100, 'Discrimina I.V.A.', 'Discrimina el I.V.A.', 'Indica si se discrimina I.V.A. para este contribuyente', 0, 'OPB_LAR', 'DiscriminateTax', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 1, 'N', 70, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 17:22:45.0', 100, 100, 'Clase Documento', 'Clase de Documento del contribuyente', 'Indica la clase de documento del contribuyente (CUIT, CUIL, DNI, etc.)', 0, 'OPB_LAR', 'LAR_ClaseDocumento_ID', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
18, 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=14),  -- AD_Reference_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 25, 'N', 80, NULL, 'Y', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.', 0, 'OPB_LAR', 'IsActive', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 1, 'N', 90, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Element(ad_element_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, columnname, entitytype, name, printname, description, help, po_name, po_printname, po_description, po_help)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=188),  --  AD_Element_ID
 0, 0, 'Y', '2010-08-30 16:12:15.0', 100, '2010-08-30 16:12:15.0', 100, 'LAR_TipoContribuyente_ID', 'OPB_LAR', 'Tipo Contribuyente', 'Tipo Contribuyente', 'Tipo de contribuyente', 'Indica el tipo de contribuyente para AFIP', NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:44.0', '2010-08-30 16:37:44.0', 100, 100, 'Tipo Contribuyente', 'Tipo de contribuyente', 'Indica el tipo de contribuyente para AFIP', 0, 'OPB_LAR', 'LAR_TipoContribuyente_ID', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'N', NULL, 10, 'N', NULL, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 16:37:45.0', 100, 100, 'Created', 'Date this record was created', 'The Created field indicates the date that this record was created.', 0, 'OPB_LAR', 'Created', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 16:37:45.0', 100, 100, 'Created By', 'User who created this records', 'The Created By field indicates the user who created this record.', 0, 'OPB_LAR', 'CreatedBy', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 16:37:45.0', 100, 100, 'Updated', 'Date this record was updated', 'The Updated field indicates the date that this record was updated.', 0, 'OPB_LAR', 'Updated', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
0, 0, 'Y', '2010-08-30 16:37:45.0', '2010-08-30 16:37:45.0', 100, 100, 'Updated By', 'User who updated this records', 'The Updated By field indicates the user who updated this record.', 0, 'OPB_LAR', 'UpdatedBy', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID 
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=27),  -- AD_Window_ID
NULL, NULL, NULL, NULL, NULL, 'OPB_LAR', 'Y');
