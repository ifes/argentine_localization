...
0, 0, 'Y', '2010-08-24 23:35:45.0', 100, '2010-08-24 23:35:45.0', 100, 'Clase Documento', 'Clases de Documentos', 'Esta ventana permite definir las diferentes clases de documento que se asignan a los socios de negocio (CUIT, CUIL, DNI, etc.)', 'M', 'Y', 'OPB_LAR', 'N', NULL, NULL, 'N', 0, 0, 'N');
...
0, 0, 'Y', '2010-08-24 23:29:25.0', 100, '2010-08-24 23:29:25.0', 100, 'Clase Documento', 'Clase de Documento del contribuyente', 'Indica la clase de documento del contribuyente (CUIT, CUIL, DNI, etc.)', 'LAR_ClaseDocumento', 'N', '6', 'OPB_LAR', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=27),  -- AD_Window_ID
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=188),  --  AD_Element_ID
 0, 0, 'Y', '2010-08-24 23:24:23.0', 100, '2010-08-24 23:24:23.0', 100, 'LAR_ClaseDocumento_ID', 'OPB_LAR', 'Clase Documento', 'Clase Documento', 'Clase de Documento del contribuyente', 'Indica la clase de documento del contribuyente (CUIT, CUIL, DNI, etc.)', NULL, NULL, NULL, NULL);
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Clase Documento', 'Clase de Documento del contribuyente', 'Indica la clase de documento del contribuyente (CUIT, CUIL, DNI, etc.)', 0, 'OPB_LAR', 'LAR_ClaseDocumento_ID', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Client', 'Client/Tenant for this installation.', 'A Client is a company or a legal entity. You cannot share data between Clients. Tenant is a synonym for Client.', 0, 'OPB_LAR', 'AD_Client_ID', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 10, 'N', 10, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Organization', 'Organizational entity within client', 'An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.', 0, 'OPB_LAR', 'AD_Org_ID', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 10, 'N', 20, NULL, 'Y', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 1, 'N', 80, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Created', 'Date this record was created', 'The Created field indicates the date that this record was created.', 0, 'OPB_LAR', 'Created', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Created By', 'User who created this records', 'The Created By field indicates the user who created this record.', 0, 'OPB_LAR', 'CreatedBy', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Updated', 'Date this record was updated', 'The Updated field indicates the date that this record was updated.', 0, 'OPB_LAR', 'Updated', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Updated By', 'User who updated this records', 'The Updated By field indicates the user who updated this record.', 0, 'OPB_LAR', 'UpdatedBy', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Name', 'Alphanumeric identifier of the entity', 'The name of an entity (record) is used as an default search option in addition to the search key. The name is up to 60 characters in length.', 0, 'OPB_LAR', 'Name', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 60, 'N', 40, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:32.0', '2010-08-24 23:29:32.0', 100, 100, 'Description', 'Optional short description of the record', 'A description is limited to 255 characters.', 0, 'OPB_LAR', 'Description', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 255, 'N', 50, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Element(ad_element_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, columnname, entitytype, name, printname, description, help, po_name, po_printname, po_description, po_help)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=188),  --  AD_Element_ID
 0, 0, 'Y', '2010-08-24 23:25:56.0', 100, '2010-08-24 23:25:56.0', 100, 'IsMandatoryDocNo', 'OPB_LAR', 'Nro Documento Obligatorio', 'Nro Documento Obligatorio', 'Nro Documento Obligatorio', 'Indica que el numero de documento es obligatorio para este contribuyente', NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:33.0', '2010-08-24 23:30:30.0', 100, 100, 'Nro Documento Obligatorio', 'Nro Documento Obligatorio', 'Indica que el numero de documento es obligatorio para este contribuyente', 0, 'OPB_LAR', 'IsMandatoryDocNo', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 1, 'N', 60, NULL, 'N', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Element(ad_element_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, columnname, entitytype, name, printname, description, help, po_name, po_printname, po_description, po_help)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=188),  --  AD_Element_ID
 0, 0, 'Y', '2010-08-24 23:27:04.0', 100, '2010-08-24 23:27:04.0', 100, 'IsValidationRequired', 'OPB_LAR', 'Validacion requerida', 'Validacion requerida', 'Documento requiere validacion', 'Indica que para este tipo de documento se requiere validar el numero ingresado', NULL, NULL, NULL, NULL);
...
INSERT INTO adempiere.AD_Column(ad_column_id, ad_client_id, ad_org_id, isactive, created, updated, createdby, updatedby, name, description, help, version, entitytype, columnname, ad_table_id, ad_reference_id, ad_reference_value_id, ad_val_rule_id, fieldlength, defaultvalue, iskey, isparent, ismandatory, isupdateable, readonlylogic, isidentifier, seqno, istranslated, isencrypted, callout, vformat, valuemin, valuemax, isselectioncolumn, ad_element_id, ad_process_id, issyncdatabase, isalwaysupdateable, columnsql, mandatorylogic, infofactoryclass, isautocomplete, isallowlogging, formatpattern)
  VALUES(
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 0, 0, 'Y', '2010-08-24 23:29:33.0', '2010-08-24 23:30:19.0', 100, 100, 'Validacion requerida', 'Documento requiere validacion', 'Indica que para este tipo de documento se requiere validar el numero ingresado', 0, 'OPB_LAR', 'IsValidationRequired', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=21),  -- AD_Table_ID
 20, NULL, NULL, 1, 'N	', 'N', 'N', 'Y', 'Y', NULL, 'N', NULL, 'N', 'N', NULL, NULL, NULL, NULL, 'N', 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=188),  --  AD_Element_ID
 NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL);
...
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=19),  --  AD_Tab_ID 
(SELECT CurrentNext FROM adempiere.AD_Sequence WHERE AD_Sequence_ID=3),  --  AD_Column_ID
 NULL, 'Y', NULL, 1, 'N', 70, NULL, 'Y', 'N', 'N', 'N', 'OPB_LAR', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
