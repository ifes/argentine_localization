...
public interface I_LAR_PaymentHeader 
{
    ...
    /** Column name BuscarPagos */
    public static final String COLUMNNAME_BuscarPagos = "BuscarPagos";

	/** Set BuscarPagos	  */
	public void setBuscarPagos (String BuscarPagos);

	/** Get BuscarPagos	  */
	public String getBuscarPagos();
	...
	/** Set ProcessIt	  */
	public void setProcessIt (String ProcessIt);

	/** Get ProcessIt	  */
	public String getProcessIt();
