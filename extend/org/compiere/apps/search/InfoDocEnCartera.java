 ...
 *
 */
public class InfoDocEnCartera extends Info
{
	/**
	 * 
	 */
	 ...
	 */
	protected InfoDocEnCartera(Frame frame, boolean modal, int WindowNo, String value,
...
//	private VLookup fOrg_ID;
	...
	{
		return new InfoDocEnCartera(frame, modal, WindowNo, value, multiSelection, whereClause);
	}
}   //  InfoPayment
