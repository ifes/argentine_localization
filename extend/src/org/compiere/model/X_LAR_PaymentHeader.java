...
// DR
	...
	/** Set BuscarPagos.
		@param BuscarPagos BuscarPagos	  */
	public void setBuscarPagos (String BuscarPagos)
	{
		set_Value (COLUMNNAME_BuscarPagos, BuscarPagos);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_BuscarPagos);
	}
	...
	{
		set_Value (COLUMNNAME_Detalle, Boolean.valueOf(Detalle));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_Detalle);
		if (oo != null) 
		{
	...
	/** Set LAR_PaymentHeader_ID.
		@param LAR_PaymentHeader_ID LAR_PaymentHeader_ID	  */
	...
	{
		set_Value (COLUMNNAME_ProcessIt, ProcessIt);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_ProcessIt);
	}
}