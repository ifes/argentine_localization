...
* 																	  *
* Integrados parches Carlos Ruiz                                      *
* http://kenai.com/projects/adempiere361/sources/adempiere361/revision/6067 *
* Fix bug when checking if the process is already configured          *
* Reported by AFalcone and suggested fix                              *
* here -> http://red1.org/adempiere/viewtopic.php?f=34&t=1193         *
* Also refactored the generation of the process to make it smart in   *
* case a new tab is added to a window and it requires to configure    * 
* new processes                          							  *
***********************************************************************/
