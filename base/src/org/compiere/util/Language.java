...
public class Language implements Serializable
{
	...
	private static final String AD_Language_es_AR = "es_AR";  // afalcone: lenguaje Argentina
	...
	static private Language[]   s_languages = {
		...
		new Language ("Espa\u00f1ol (AR)",
			AD_Language_es_AR,  new Locale("es","ES"), new Boolean(false), "dd/MM/yyyy",
			MediaSize.NA.LETTER),  // afalcone: lenguaje Argentina
